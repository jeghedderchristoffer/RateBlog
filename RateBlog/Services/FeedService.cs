...
namespace Bestfluence.Services
{
    public class FeedService : IFeedService
    {
        ...
        public async Task<IEnumerable<RSSFeed>> GetBlogFeedAsync(string blogUrl, string parameter)
        {
        ...
        public async Task<IEnumerable<RSSFeed>> GetYoutubeFeedAsync(string youtubeUrl, string parameter)
        {
        ...
        public async Task<IEnumerable<RSSFeed>> GetInstagramFeedAsync(string instagramUrl)
        {
            var url = "https://websta.me/rss/n/";
