...
namespace Bestfluence.Migrations
{
    ...
    [Migration("20171004141416_FixingEngagement")]
    partial class FixingEngagement
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Bestfluence.Models.Country", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Bestfluence.Models.YoutubeAgeGroup", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("EighteenTothirtyfour");

                    b.Property<int>("FiftyfiveToSixtyfive");

                    b.Property<int>("FortyFiveTofiftyfive");

                    b.Property<int>("SixtyfivePlus");

                    b.Property<int>("ThirteenToSeventeen");

                    b.Property<int>("ThirtyfiveTofortyfour");

                    b.Property<string>("YoutubeDataId");

                    b.HasKey("Id");

                    b.HasIndex("YoutubeDataId")
                        .IsUnique();

                    b.ToTable("YoutubeAgeGroup");
                });

            modelBuilder.Entity("Bestfluence.Models.YoutubeCountry", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("YoutubeCountry");
                });

            modelBuilder.Entity("Bestfluence.Models.YoutubeData", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Bestfluence.Models.BlogComment", b =>
                {
                    ...
                    b.HasOne("Bestfluence.Models.BlogArticle", "BlogArticle")
            ...
            modelBuilder.Entity("Bestfluence.Models.YoutubeAgeGroup", b =>
                {
                    b.HasOne("Bestfluence.Models.YoutubeData", "YoutubeData")
                        .WithOne("YoutubeAgeGroup")
                        .HasForeignKey("Bestfluence.Models.YoutubeAgeGroup", "YoutubeDataId");
                });

            modelBuilder.Entity("Bestfluence.Models.YoutubeCountry", b =>
                {
                    b.HasOne("Bestfluence.Models.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId");

                    b.HasOne("Bestfluence.Models.YoutubeData", "YoutubeData")
                        .WithMany("YoutubeCountry")
                        .HasForeignKey("YoutubeDataId");
                });
            ...
            modelBuilder.Entity("Bestfluence.Models.YoutubeData", b =>
                {
                    b.HasOne("Bestfluence.Models.Influencer", "Influencer")
                        .WithOne("YoutubeData")
                        .HasForeignKey("Bestfluence.Models.YoutubeData", "InfluencerId");
                });
