...
namespace Bestfluence.Migrations
{
    ...
    [Migration("20171001230128_InstadatanowwithDatetime")]
    partial class InstadatanowwithDatetime
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Bestfluence.Models.City", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Bestfluence.Models.InstagramAgeGroup", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Bestfluence.Models.InstagramCity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Bestfluence.Models.InstagramCountry", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Bestfluence.Models.InstagramAgeGroup", b =>
                {
                    b.HasOne("Bestfluence.Models.InstagramData", "InstagramData")
                        .WithOne("InstagramAgeGroup")
                        .HasForeignKey("Bestfluence.Models.InstagramAgeGroup", "InstagramDataId");
                });

            modelBuilder.Entity("Bestfluence.Models.InstagramCity", b =>
                {
                    b.HasOne("Bestfluence.Models.City", "City")
                        .WithMany()
